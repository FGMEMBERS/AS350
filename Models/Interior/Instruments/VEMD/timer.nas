...
var p = "/sim/model/bo105/flight-duration/";
			...
			var bg = props.globals.getNode("/sim/model/bo105/flight-duration", 1);
...
####OSGtext seems not to read var d. So work around####
			...
			var show = func(s) {
			        var display_hr = props.globals.getNode("/sim/model/bo105/flight-duration/hr", 1);
				var display_mn = props.globals.getNode("/sim/model/bo105/flight-duration/mn", 1);
				var hours = s / 3600;
...
init:func{
var last_fltn = props.globals.getNode("/sim/model/bo105/flightnumber").getValue() or 0;
#var trigger = props.globals.getNode("controls/engines/engine/startselector").getValue() or 0;
var fltn = props.globals.getNode("/sim/model/bo105/flightnumber", 1);
var n1 = props.globals.getNode("/engines/engine/n1-pct").getValue() or 0;
